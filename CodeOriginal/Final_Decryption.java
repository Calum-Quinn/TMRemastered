...
public class Final_Decryption {
	...
	public static void main(String[] args) {
		...
		//Entrée de la clé de décryptage par l'utilisateur
		
		System.out.println("Veuillez svp introduire la clé de décryptage chiffre par chiffre");
		...
		while (nbr < 2 || nbr > 11) {
			System.out.println("Premier chiffre/nombre");
		...
		while (nbr2 < 2 || nbr2 > 11) {
			System.out.println("Deuxième chiffre/nombre");
		...
		while (nbr3 < 2 || nbr3 > 11) {
			System.out.println("Troisième chiffre/nombre");
		...
		while (nbr4 < 2 || nbr4 > 11) {
			System.out.println("Quatrième chiffre/nombre");
		...
		while (nbr5 < 2 || nbr5 > 11) {
			System.out.println("Cinquième chiffre/nombre");
		...
		//Définition des changements qui ont été fait à l'alphabet
	    ...
	    //Changements préprogrammer
	      ...
	      //Entrée du message à décrypter
	      
	      	System.out.println("Maintenant nous allons décrypter le message, veuillez l'entrer dans la console : ");    
	      	sc.nextLine();
		    String str = sc.nextLine();
		    System.out.println("Vous avez saisi : " + str);
		    
		    //Définition du premier changement qui a été fait
		   ...
		   // 	System.out.println("NEW LETTER!!!");
		   	...
		   	monIndice1 = index;
		    	...
		    	//Changements préprogrammer pour tous les changements de l'alphabet sauf le premier
	    			...
	    			//Autres changements de l'alphabet qui était déjà changé une fois
	    			...
	    			*/
			    	...
			    	decryptedMessage.add(alphabet[j2]);
		    }
		    
		  //Sortie du message décrypté
		    
		    System.out.print("Le message décrypté est: ");
		    for (int h = 0; h<decryptedMessage.size(); h++) {
		    		System.out.print(decryptedMessage.get(h));
		    }
	}
}